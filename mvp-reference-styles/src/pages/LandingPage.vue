<template>
  <div class="min-h-screen text-foreground relative overflow-hidden">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
          <div class="flex items-center">
            <svg class="h-8 w-8 text-primary mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="flex items-center space-x-4">
            <button class="text-muted-foreground hover:text-foreground transition-colors">Entrar</button>
            <button
              @click="goToWizard"
    ...
    <!-- Hero Section -->
    <section class="relative section-fit overflow-hidden">
        ...
        <div class="text-center">
          ...
          <div ref="heroCard"
            ...
            <div
              ...
              <div class="relative">
                <svg class="w-8 h-8 text-primary mb-4 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div v-for="(feature, index) in features" :key="index" :ref="el => featureRefs[index] = el"
            ...
            <div
              ...
              <div
                ...
                <svg v-if="index === 0" class="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                </svg>
                <svg v-else-if="index === 1" class="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/>
                </svg>
                <svg v-else-if="index === 2" class="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/>
                </svg>
                <svg v-else-if="index === 3" class="w-6 h-6 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/>
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
              </svg>
        ...
        <div class="space-y-4">
          <div v-for="(faq, index) in faqs" :key="index" :ref="el => faqRefs[index] = el"
            ...
            <button @click="toggleFaq(index)"
              ...
              <svg class="w-5 h-5 transition-transform duration-200" :class="{ 'rotate-180': openFaq === index }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <footer ref="footer"
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p class="text-muted-foreground text-sm">
            © 2025 TeacherPlus. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
